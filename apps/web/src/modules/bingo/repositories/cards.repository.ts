...
/** Fields that can be updated on a card (excludes system-managed fields) */
export type UpdatableBingoCardFields = Omit<BingoCard, 'id' | 'createdAt' | 'updatedAt'>;
...
export interface CardsRepository {
  ...
  update(cardId: string, data: Partial<UpdatableBingoCardFields>): Promise<BingoCard>;
...
interface PrismaClientInterface {
  bingoCard: {
    ...
    update: (args: { where: { id: string }; data: Partial<UpdatableBingoCardFields> }) => Promise<BingoCard>;
...
export class PrismaCardsRepository implements CardsRepository {
  ...
  async update(cardId: string, data: Partial<UpdatableBingoCardFields>): Promise<BingoCard> {
